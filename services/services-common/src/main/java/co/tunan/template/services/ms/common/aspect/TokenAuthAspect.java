package co.tunan.template.services.ms.common.aspect;
...
import co.tunan.template.common.helper.exception.TokenInvalidException;
...
public class TokenAuthAspect {
     ...
     * pointcut
     */
    @Pointcut("@within(co.tunan.template.services.ms.common.annotion.TokenValidator) " +
            "|| @annotation(co.tunan.template.services.ms.common.annotion.TokenValidator)")
